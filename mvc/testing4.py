...
class MyCheckbuttonGUI:
    def __init__(self):
        ...
        self.chb1 = tkinter.Checkbutton(self.top_frame, text='Variant 1', variable=self.check_var1)
        self.chb2 = tkinter.Checkbutton(self.top_frame, text='Variant 2', variable=self.check_var2)
        self.chb3 = tkinter.Checkbutton(self.top_frame, text='Variant 3', variable=self.check_var3)
